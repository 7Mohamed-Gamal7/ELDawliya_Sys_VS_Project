...
Namespace El_Dawliya_International_System.Forms.Report
    ...
    Public Class Sick_Newspaper
        ...
        Public Overrides Property FullResourceName() As String
            Get
                Return "El_Dawliya_International_System.Sick_Newspaper.rpt"
            End Get
            Set
                'Do nothing
            End Set
    ...
    Public Class CachedSick_Newspaper
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As Sick_Newspaper = New Sick_Newspaper()
            rpt.Site = Me.Site
            Return rpt
        End Function
