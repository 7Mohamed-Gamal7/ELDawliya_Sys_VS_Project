...
Public Class Frm_Alerts
    ...
    'Private Sub TaskStartDate_Leave(sender As Object, e As EventArgs) Handles TaskStartDate.Leave
    '    ' إنشاء حدث KeyEventArgs
    '    Dim keyEventArgs As New KeyEventArgs(Keys.Enter)
    '    ' استدعاء الحدث KeyDown
    '    TaskStartDate_KeyDown(TaskStartDate, keyEventArgs)
    'End Sub

    'Private Sub TaskEndDate_Leave(sender As Object, e As EventArgs) Handles TaskEndDate.Leave
    '    ' إنشاء حدث KeyEventArgs
    '    Dim keyEventArgs As New KeyEventArgs(Keys.Enter)
    '    ' استدعاء الحدث KeyDown
    '    TaskEndDate_KeyDown(TaskEndDate, keyEventArgs)
    'End Sub
